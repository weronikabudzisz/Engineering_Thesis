...
function toggleMarkers() {
    ...
    const lachyLayer = map.getLayer('my-layer');
...
for (const marker of miejsce_wodowania) {
    ...
    // Dodanie zdarzenia klliknięcia zamknięcia popupu
    popup.on('close', function () {
        // Po kliknięciu oddalenie do defaultowego zbliżenia mapy
        map.flyTo({
            center: [20.135593, 51.507811],
            zoom: 11
        });
    });
}
